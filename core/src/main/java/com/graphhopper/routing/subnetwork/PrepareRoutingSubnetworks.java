...
public class PrepareRoutingSubnetworks {
    ...
    protected int setSubnetworks(Weighting weighting, String jobName, BitSet subnetworkFlags) {
    ...
    protected int setSubnetworkEdge(int edgeKey, Weighting weighting, BitSet subnetworkFlags) {
