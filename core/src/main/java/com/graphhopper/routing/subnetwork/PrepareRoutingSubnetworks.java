...
public class PrepareRoutingSubnetworks {
    ...
    protected int setSubnetworks(PrepareJob job) {
        return setSubnetworks(job.weighting, job.subnetworkEnc);
    }
    ...
    protected int setSubnetworkEdge(int edgeKey, Weighting weighting, BooleanEncodedValue subnetworkEnc) {
